...
public class CrateDbDialect extends PostgreSQLDialect {
    ...
    protected String columnType(int sqlTypeCode) {
        switch (sqlTypeCode) {
            case TIMESTAMP:
                return "timestamp"; // FIXME does not support precision for timestamps
            case TIMESTAMP_WITH_TIMEZONE:
                return "timestamp with time zone"; // FIXME does not support precision for timestamps
            case NUMERIC:
                return "text";
            case JSON:
    ...
    public void contribute(TypeContributions typeContributions, ServiceRegistry serviceRegistry) {
        ...
        contributeCrateTypes(typeContributions, serviceRegistry);
    }

    private void contributeCrateTypes(TypeContributions typeContributions, ServiceRegistry serviceRegistry) {
        final JdbcTypeRegistry jdbcTypeRegistry = typeContributions.getTypeConfiguration().getJdbcTypeRegistry();

        jdbcTypeRegistry.addDescriptor(CrateJsondbcType.JSON_INSTANCE);
